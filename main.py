...
st.set_page_config(page_title="QuantStudio Analysis", page_icon=😎, layout="wide", initial_sidebar_state="auto")
file_saved = st.file_uploader(f"Upload file 😴:", accept_multiple_files=False)
